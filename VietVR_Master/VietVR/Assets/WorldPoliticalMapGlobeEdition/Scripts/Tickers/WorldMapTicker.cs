				...
				public class WorldMapTicker : MonoBehaviour {
								...
								void OnDestroy () {
												...
												if (overlayLayer == null)
																return;
												Transform t = overlayLayer.transform.Find (TICKERS_LAYER);
												if (t != null) {
								...
								public void AddTickerText (TickerText tickerText) {
												...
												GameObject tickerTextObj = Drawing.CreateText (tickerText.text, null, tickerBandObj.layer, pos, tickerText.font, tickerText.textColor, tickerText.drawTextShadow, tickerText.shadowMaterial, tickerText.shadowColor, tickerText.textAnchor).gameObject;
