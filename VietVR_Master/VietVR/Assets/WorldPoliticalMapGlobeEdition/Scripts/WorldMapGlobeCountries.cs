...
namespace WPM {
	...
	/* Event definitions */
	public delegate void OnCountryBeforeEnterEvent (int countryIndex, int regionIndex, ref bool ignoreCountry);
	...
	public partial class WorldMapGlobe : MonoBehaviour {
		...
		public event OnCountryBeforeEnterEvent OnCountryBeforeEnter;
